# https://gitlab.com/pycqa/flake8/-/raw/master/docs/source/user/error-codes.rst
FLAKE8_CODES = r'''
...
# or https://raw.githubusercontent.com/PyCQA/pycodestyle/master/docs/intro.rst
PYCODESTYLE_CODES = r'''
| **E1**     | *Indentation*                                                        |
+------------+----------------------------------------------------------------------+
...
# https://github.com/PyCQA/mccabe/blob/master/mccabe.py#L233
MCCABE_CODES = '''
...
def parse_codes():
    source = FLAKE8_CODES + PYCODESTYLE_CODES + MCCABE_CODES
    codes = {}
    for line in source.splitlines():
        if line.startswith(('| E', '| W', '| F', '| C')):
            code, message = line.strip('| ').split(' | ')
            codes[code.split()[0]] = message
    return codes
